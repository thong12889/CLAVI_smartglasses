...
public class Clavi_object : UnityEngine.MonoBehaviour
{
    ...
    private UnityEngine.TextAsset labelMap = null;
    ...
    private void Process(Mat image)
    {
        ...
        CaptureImage.texture = OpenCvSharp.Unity.MatToTexture(image);
    }
